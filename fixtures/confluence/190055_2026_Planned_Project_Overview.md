...
module: ["Channel standard", "MDC development guideline", "Template & content standard", "Integration & API standard", "Delivery & tracking standard", "Operations & release standard"]
